...
🔴 ФОРМАТ СЦЕНЫ: каждый объект в scenes — ПЛОСКИЙ: {"type", "fromMs", "toMs", и поля данных прямо здесь}. НЕ оборачивай поля в "data"/"props"/"payload". Пример: {"type":"PunchWord","fromMs":8000,"toMs":10000,"word":"ИЗМЕНА","sub":"...","filled":true}.
